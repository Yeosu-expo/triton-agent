...
func CreateHandler() *Handler {
	...
	mux.HandleFunc("/provider/{provider:[0-9a-zA-Z-_]+}/model/{model:[0-9a-zA-Z-]+}/{version:[0-9]+}/infer", handler.inferV2Handler).Methods("POST")          // Inference version 2.0
	mux.HandleFunc("/provider/{provider:[0-9a-zA-Z-_]+}/model/{model:[0-9a-zA-Z-]+}/{version:[0-9]+}/infer/test", handler.testInferV2Handler).Methods("POST") // Inference version 2.0
